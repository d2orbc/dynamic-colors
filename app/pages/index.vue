      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
          <div class="flex items-center gap-6">
            ...
            <div class="hidden md:flex items-center gap-2 text-sm text-surface-600">
    ...
    <main class="max-w-7xl mx-auto px-4 py-8 space-y-12">
      ...
      <section class="bg-surface-100 rounded-xl p-6 shadow-sm border border-surface-200">
        <div class="space-y-6">
          ...
          <div>
            <h3 class="text-lg font-semibold text-surface-900 mb-4">Quick Theme Selection</h3>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              >
                ...
                <span class="text-sm font-medium capitalize text-surface-700">{{ name }}</span>
              </button>
            </div>
          </div>
          ...
          <div class="border-t border-surface-200 pt-6">
            <h3 class="text-lg font-semibold text-surface-900 mb-4">Customize Colors</h3>
              ...
              <div>
                ...
                <div class="relative">
                  <button
                    ...
                    class="w-full flex items-center gap-2 px-3 py-2 border border-surface-300 rounded-lg hover:border-surface-400 transition-colors bg-white"
                  >
                    <span 
                      class="w-6 h-6 rounded ring-2 ring-white shadow-sm"
                      :style="{ backgroundColor: getColorPreview(customConfig.primary) }"
                    />
                    <span class="flex-1 text-left text-sm capitalize">{{ customConfig.primary }}</span>
                    <svg class="w-4 h-4 text-surface-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </button>
                  <div v-if="showPrimaryPicker" class="absolute z-10 mt-2 w-full bg-white rounded-lg shadow-lg border border-surface-200 p-2">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  >
                    ...
                    />
                    <span class="flex-1 text-left text-sm capitalize">{{ customConfig.secondary }}</span>
                    <svg class="w-4 h-4 text-surface-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </button>
                  <div v-if="showSecondaryPicker" class="absolute z-10 mt-2 w-full bg-white rounded-lg shadow-lg border border-surface-200 p-2">
                    <div class="grid grid-cols-5 gap-1 max-h-48 overflow-y-auto">
                      <button
                        v-for="color in availableColors"
                        :key="color"
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  >
                    ...
                    />
                    <span class="flex-1 text-left text-sm capitalize">{{ customConfig.surface }}</span>
                    <svg class="w-4 h-4 text-surface-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </button>
                  <div v-if="showSurfacePicker" class="absolute z-10 mt-2 w-full bg-white rounded-lg shadow-lg border border-surface-200 p-2">
                    <div class="grid grid-cols-5 gap-1 max-h-48 overflow-y-auto">
                      <button
                        v-for="color in availableColors"
                        :key="color"
      ...
      <section class="space-y-6">
        <h3 class="text-2xl font-bold text-surface-900">Component Examples</h3>
        
        <!-- Buttons -->
        <div class="bg-surface-100 rounded-xl p-6 shadow-sm border border-surface-200">
          <h4 class="text-lg font-semibold text-surface-800 mb-4">Buttons</h4>
          <div class="flex flex-wrap gap-3">
            <button class="px-6 py-2.5 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors font-medium">
              Primary Button
            </button>
            <button class="px-6 py-2.5 bg-secondary-500 text-white rounded-lg hover:bg-secondary-600 transition-colors font-medium">
              Secondary Button
            </button>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="bg-primary-50 p-6 rounded-xl border border-primary-200 hover:shadow-md transition-shadow">
            ...
            <button class="bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-600 transition-colors text-sm font-medium">
              Try it now
            </button>
          </div>
          ...
          <div class="bg-secondary-50 p-6 rounded-xl border border-secondary-200 hover:shadow-md transition-shadow">
            ...
            <button class="bg-secondary-500 text-white px-4 py-2 rounded-lg hover:bg-secondary-600 transition-colors text-sm font-medium">
              Export theme
            </button>
          </div>
        </div>
        ...
        <div class="space-y-3">
          <div class="bg-primary-50 border border-primary-200 text-primary-800 px-4 py-3 rounded-lg flex items-center gap-3">
            ...
            <span class="text-sm">This is a primary alert using theme colors</span>
          </div>
          <div class="bg-secondary-50 border border-secondary-200 text-secondary-800 px-4 py-3 rounded-lg flex items-center gap-3">
            <svg class="w-5 h-5 text-secondary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span class="text-sm">This is a secondary alert with custom styling</span>
          </div>
        </div>
      </section>
    </main>
...
const setTheme = (themeName: string) => {
  ...
  if (themes[themeName]) {
    customConfig.value = {
      primary: themes[themeName].primary,
      secondary: themes[themeName].secondary,
      surface: themes[themeName].surface
    }
  }
}
...
onMounted(() => {
  ...
  if (themes[currentTheme.value]) {
    customConfig.value = {
      primary: themes[currentTheme.value].primary,
      secondary: themes[currentTheme.value].secondary,
      surface: themes[currentTheme.value].surface
    }
  }
})
</script>